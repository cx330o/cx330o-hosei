...
const TrainSheet = (props: Props) => {
  if (!props.trains || props.trains.length === 0) {
    return (
      <div className='flex justify-between dark:bg-white not-dark:bg-black p-1 rounded-md w-full dark:text-black not-dark:text-white items-center'>
        <p>
          <TrainIcon size={30} className='text-center' />
        </p>
        <p className='text-sm'>電車情報がありません</p>
