...
def client():
    ...
    with app.app_context():
        ...
        s = User(username="student1", email="s@test.com", password=pw, role="student", department="情報科学部")
        t = User(username="teacher1", email="t@test.com", password=pw, role="teacher", department="法学部")
...
class TestAuth:
    ...
    def test_signup(self, client):
        r = client.post("/signup/student", data={
            "username": "newuser", "email": "new@test.com", "password": "pass123", "department": "文学部"
